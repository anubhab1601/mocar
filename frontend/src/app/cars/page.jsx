        ...
        <div className="container">
          <div style={{ position: 'relative' }}>
            <div className="section-header">
              <h1>Self Drive Cars in Bhubaneswar</h1>
              <p>Choose from well-maintained hatchbacks, sedans, and SUVs with flexible rental periods.</p>
            </div>
            {mounted && isAdmin && (
              ...
              <div key={car.id} style={{ position: 'relative' }}>
                ...
                {editId === car.id ? (
                  <AdminCarForm
                    form={editForm}
                    onChange={setEditForm}
                    onSave={() => handleEditSave(car.id)}
                    onCancel={() => setEditId(null)}
                    isCard
                  />
                ) : (
                  <VehicleCard {...car} fallback={heroFallback} />
                )}
              </div>
            ))}
          </div>
      ...
      <section className="section section-alt">
        <div className="container text-center">
          ...
          <p style={{ fontSize: '1.05rem', marginBottom: 28, maxWidth: 720, marginInline: 'auto' }}>
            Tell us your trip plan and we will match you with the right car and pricing slot (6h / 12h / 24h).
          </p>
...
function AdminCarForm({ form, onChange, onSave, onCancel, isCard }) {
  return (
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 15, marginBottom: 20 }}>
        ...
        <div style={{ gridColumn: '1 / -1' }}>
          <label style={{ display: 'block', marginBottom: 5, fontSize: '0.9rem', color: '#666' }}>Car Image (Required)</label>
